...
import background from '../../../Resources/images/LoginBackground.png'
import logo from '../../../Resources/images/AppLogo_Start.png'
         ...
         <main className="w-full flex">
            <div className="relative flex-1 hidden items-center justify-center h-screen bg-gray-900 lg:flex">
                <div className="relative z-10 w-full max-w-md">
                    ...
                    <div className=" mt-16 space-y-3">
                        <h3 className="text-white text-2xl font-bold">Start growing your business quickly</h3>
            ...
            <div className="flex-1 flex items-center justify-center h-screen">
                <div className="w-full max-w-md space-y-8 px-4 bg-white text-gray-600 sm:px-0">
                    <div className="">
                        <img src={logo} alt='/' width={150} className="lg:hidden" />
                        <div className="mt-5 space-y-2">
                            <h3 className="text-gray-800 text-2xl font-bold sm:text-3xl">Sign up</h3>
                            <p className="">Already have an account? <Link  to={"/"} className="font-medium text-indigo-600 hover:text-indigo-500">Log in</Link></p>
                        </div>
                    </div>
